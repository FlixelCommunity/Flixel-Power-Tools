...
package org.flixel.plugin.photonstorm 
{
    ...
    public class FlxBitmapFont extends FlxSprite
    {
        ...
        /**
         * Set this value to update the text in this sprite. Carriage returns are automatically stripped out if multiLine is false. 
         * Text is converted to upper case if autoUpperCase is true.
         * 
         * @return    void
         */ 
         ...
         * @param    customSpacingX    Additional horizontal spacing
         */
